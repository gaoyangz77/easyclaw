export default {
  ...
  settings: {
    ...
    browser: {
      ...
      modeCdpDesc: "Use your own Chrome with all your accounts, cookies, and extensions. Note: Chrome will be closed and relaunched immediately, and will also auto-launch with the app on every startup.",
